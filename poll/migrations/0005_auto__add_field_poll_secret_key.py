...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poll.secret_key'
        db.add_column('poll_poll', 'secret_key',
                      self.gf('poll.fields.UUIDField')(default='', max_length=64, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poll.secret_key'
        db.delete_column('poll_poll', 'secret_key')
